...
$route['admin/survey'] 			    	=				 'admin/Admin/survey';
$route['admin/all-survey'] 				=				 'admin/Admin/all_survey';
$route['admin/savingdata'] 				=				 'admin/Admin/savingdata';
$route['admin/survey-view'] 		    =				 'admin/Admin/survey_view';